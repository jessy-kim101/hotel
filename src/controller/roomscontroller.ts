import { createRoomService, deleteRoomService, getAllRoomsService, getRoomByIdService, updateRoomService } from '../services/roomsservice';
...
export const updateRoomsController = async (req: any, res: any) => {
    try {
        const roomId = parseInt(req.params.id);
        const updates = req.body;
        const updatedRoom = await updateRoomService(roomId, updates);
        if (!updatedRoom) {
